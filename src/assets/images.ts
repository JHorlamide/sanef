...
export const NNEKA_ONYEALI = `${BOARD_IMAGE_PATH}/Nneka-Onyeali.png`;
export const ROOSEVELT_OGBONNA = `${BOARD_IMAGE_PATH}/Roosevelt-Ogbonna.png`;
export const OLIVER_ALAWUBA = `${BOARD_IMAGE_PATH}/Oliver-Alawuba.png`;
...
export const PARKWAY = `${SUPER_AGENT_IMAGE_PATH}/superagent_parkway.png`;
